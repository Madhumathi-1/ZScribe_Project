		...
		<div class="wrapper">
			...
			<div style="display: flex;flex-direction: row;">
				<div class="writer block">
					<a target=_blank style="color: #000;" href=<%
				...
				<div class="blogger block">
					...
					<div class="blogger-pic content">
						<img style="width: 100px;" class="blogger-logo logo" src="https://www.freeiconspng.com/thumbs/blogger-logo-icon-png/blogger-logo-icon-png-10.png">
					</div>
